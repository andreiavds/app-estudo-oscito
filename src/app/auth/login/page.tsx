...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      // Generate device ID for single device login
      ...
      // Update user metadata with device ID
    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-4">
      <Card className="w-full max-w-md bg-green-950/30 border-green-900/30">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-green-400">Entrar na sua conta</CardTitle>
          <CardDescription className="text-green-600">
            Acesse sua conta para continuar seus estudos OSCE
          </CardDescription>
        </CardHeader>
        <CardContent>
